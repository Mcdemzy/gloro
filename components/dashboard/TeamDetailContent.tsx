            ...
            <div className="flex-1 p-8">
              <div className="flex flex-col lg:flex-row lg:items-start justify-between mb-4">
                <div className="mb-6 lg:mb-0">
                  ...
                  <div className="flex items-center  gap-3 mb-4"><h1 className="text-2xl font-bold text-white orbitron">
                    {teamData.name}
                  </h1>
                    <span className="px-4 py-2 bg-[#065174] text-[#00000080] rounded-xl text-sm font-semibold flex items-center gap-2">
