...
const JoinedChannelsPage = () => {
  ...
  const communities: Community[] = [
    ...
    {
      id: 3,
      name: "Free Fire Battle Royale League",
      members: 12,
      image:
  ...
  const handleViewChannel = (channelId: number) => {
    router.push(`/dashboard/communities/channels/${channelId}`);
  };
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {communities.map((community) => (
          <div
            key={community.id}
            onClick={() => handleViewChannel(community.id)}
