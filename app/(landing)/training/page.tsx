      ...
      <div className="w-full min-h-screen pt-52">
        ...
        <div className="w-full px-6 md:px-12 lg:px-24 pb-18">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 orbitron tracking-[5%]">
              ENJOY YOUR <br />
              <span className="text-[#3b82f6] text-4xl md:text-7xl">TRAINING</span>
            </h1>
            <p className="text-[#FFFFFFC7] font-normal text-sm md:text-lg max-w-4xl mx-auto mb-12">
