...
export default function TeamDetailView() {
  ...
  const members = [
    ...
    },
    {
      ...
      inGameName: "PhoenixRider",
      inGameId: "40291338974",
      roles: ["Sniper", "Substitute"],
      socials: {
        x: true,
        facebook: true,
    ...
    },
    {
      ...
      inGameId: "50391448075",
      roles: ["Hacker", "Field agent", "Sniper", "Substitute"],
      socials: {
        x: true,
        facebook: false,
        discord: true,
    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-[#0c3540]/60 to-[#0a2d36]/60 backdrop-blur-md border border-cyan-500/20 rounded-2xl overflow-hidden">
        ...
        <div className="pt-20 px-8 pb-8">
          <h1 className="text-3xl font-bold text-white mb-2">{teamInfo.name}</h1>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex-1 grid grid-cols-2 gap-8">
                    ...
                    <div className="space-y-2">
                      <div>
                        <p className="text-cyan-400 text-sm mb-1">{member.id}</p>
                    ...
                    <div className="space-y-2">
                      <div>
                        <p className="text-gray-400 text-sm">In-Game Name: <span className="text-white font-medium">{member.inGameName}</span></p>
                        <p className="text-gray-400 text-sm">In-Game ID: <span className="text-white font-medium">{member.inGameId}</span></p>
                      </div>
